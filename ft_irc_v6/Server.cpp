        ...
        if (!foundEof) {
            ...
            else if (command.substr(0, 5) == "quit " || command.substr(0, 5) == "QUIT ")
            {
                ...
                for (it = channel.begin(); it != channel.end(); it++)
                {
                    ...
                    if(it->second.size() == 0)
                    {
                        std::cout << "channeleeeeeeee :" << it->first << std::endl;
                        // exit(0);
                ...
                if (channel.size() > 0)
                {
                    ...
                    for (it = channel.begin(); it != channel.end(); it++)
                    {
                        for (it1 = it->second.begin(); it1 != it->second.end(); it1++)
                        {
                            std::cout << "it1 print :" << std::endl;
                            std::cout << i << " = " << *it1 << std::endl;
                            i++;
                        }
                        std::cout << "kadlsfhdjsfdsfasfhasfasdf" << std::endl;
                    }
                }
                // if (invited.size() != 0)
                // {
                //     for (it = invited.begin(); it != invited.end(); it++)
                //     {
                //         for (it1 = it->second.begin(); it1 != it->second.begin(); it1++)
                //         {
                //             std::cout << *it1 << std::endl;
                //         }
                //     }
